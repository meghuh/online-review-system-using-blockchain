...
namespace TamperApplication
{
    public class Sha384mManaged
    {
        ...
        public void Computehash(byte[] data, uint offset, uint len)
        {
            if (closed)
        ...
        public ReadOnlyCollection<UInt32> GetHashUInt32()
        {
            if (!closed)
            {
                ...
                Computehash(new byte[1] { 0x80 }, 0, 1);
                ...
                Computehash(padding, 0u, (uint)padding.Length);
        ...
        {
            Sha384mManaged sha = new Sha384mManaged();
            ...
            do
            {
                ...
                sha.Computehash(buf, 0, bytes_read);
            }
