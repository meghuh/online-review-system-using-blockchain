<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.Master" AutoEventWireup="true" CodeBehind="UploadProductImage.aspx.cs" Inherits="OnlineReview.UploadProductImage" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:FileUpload ID="ProductImg" class="form-control" runat="server" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="ProductImg"
                                     ForeColor="#FF3300" ValidationGroup="B"  runat="server" ErrorMessage="Select Product Image"></asp:RequiredFieldValidator>
                                </div>
