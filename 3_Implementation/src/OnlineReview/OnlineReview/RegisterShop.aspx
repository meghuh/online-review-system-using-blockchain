<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterShop.aspx.cs" Inherits="OnlineReview.RegisterShop" %>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.aspx">Online Review System</a></h1>
			</div>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<!-- Mega Menu -->
									<li class="active"><a href="RegisterShop.aspx"> Create Account </a></li>
					                <li><a href="Login.aspx">Login</a></li>
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form id="form1" runat="server">
					<label>Enter Shop Name</label> &nbsp &nbsp<span><i class="fa fa-shopping-basket" aria-hidden="true"></i></span>
                <asp:TextBox ID="txtShopName" runat="server" placeholder="Enter Shop Name"></asp:TextBox><br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter Shop Name"
                  ControlToValidate="txtShopName" ForeColor="#FF3300" ValidationGroup="A"></asp:RequiredFieldValidator><br />
                
                <label>Enter Contact Person Name</label> &nbsp &nbsp<span><i class="fa fa-user" aria-hidden="true"></i></span>
                <asp:TextBox ID="txtContactPerson" runat="server" placeholder="Enter Contact Person Name"></asp:TextBox><br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Contact Person Name"
                                        ControlToValidate="txtContactPerson" ForeColor="#FF3300" ValidationGroup="A"></asp:RequiredFieldValidator><br />
